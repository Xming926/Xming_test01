...
<div class="tab_con">
    <form action="userServlet?method=save" method="post">
        <table>
            <thead><th colspan="2">用户信息修改</th></thead>
            <tr><td>用户名</td><td><input type="text" name="name" value="<%=name%>" readonly="readonly"></td></tr>
            <tr><td>密码</td><td><input type="text" name="pwd" value="<%=pwd%>"></td></tr>
            <tr><td>性别</td><td><input type="radio" name="sex" value="male" id="male"><label for="male">男</label>
                &emsp;&emsp;<input type="radio" name="sex" value="female" id="female"><label for="female">女</label></td></tr>
            <tr><td>测试成绩</td><td><input type="text" name="score1" value="<%=score1%>" readonly="readonly"></td></tr>
            <tr><td>补测成绩</td><td><input type="text" name="score2" value="<%=score2%>" readonly="readonly"></td></tr>
            <tr><td>报名重修</td><td><input type="radio" name="rebuild" value="true" id="yes"><label for="yes">是</label>&emsp;&emsp;
                    <input type="radio" name="rebuild" value="false" id="no"><label for="no">否</label></td></tr>
            <tr><td colspan="2"><input type="submit" value="确认修改">
                &emsp;&emsp;<input type="button" value="返回" id="button"></td></tr>
        </table>
    </form>
    <%
...
<div id="s" style="display: none"><%=user.getSex()%></div>
<div id="r" style="display: none"><%=user.isRebuild()%></div>
<div id="score1" style="display: none"><%=user.getScore1()%></div>
<div id="score2" style="display: none"><%=user.getScore2()%></div>
</body>
</html>
