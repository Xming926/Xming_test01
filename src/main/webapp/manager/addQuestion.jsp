...
<div class="tab_con">
    <form action="../questionsServlet?method=add" method="post">
        <table>
            <tr>
                <td>题目</td>
                <td><input type="text" name="timu" id="timu"></td>
            </tr>
            <tr>
                <td>选项A</td>
                <td><input type="text" name="A" class="item"></td>
            </tr>
            <tr>
                <td>选项B</td>
                <td><input type="text" name="B" class="item"></td>
            </tr>
            <tr>
                <td>选项C</td>
                <td><input type="text" name="C" class="item"></td>
            </tr>
            <tr>
                <td>选项D</td>
                <td><input type="text" name="D" class="item"></td>
            </tr>
            <tr>
                <td>答案</td>
            ...
            <tr>
                <td>类型</td>
                <td><input type="radio" name="type" value="1" id="d" onclick="return false;"><label for="d">单选题</label>
                    &emsp;&emsp;<input type="radio" name="type" value="2" id="s" onclick="return false;"><label for="s">多选题</label>
                </td>
            </tr>
            <tr>
                <td colspan="2"><input type="button" value="添加" id="add">
                    &emsp;&emsp;<input type="reset" value="重写" id="reset"></td>
            </tr>
        </table>
        <%
